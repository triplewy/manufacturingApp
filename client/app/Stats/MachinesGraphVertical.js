...
export default class MachinesGraphVertical extends React.Component {
  constructor(props) {
    super(props);
  ...
  renderItem(item) {
    ...
    return (
      <View style={{marginBottom: 20, alignItems: 'center', justifyContent: 'center', width: 70, marginRight: 10}}>
        ...
        <TouchableOpacity onPress={() => this.props.navigation.navigate('Reports', {date: this.props.date, lineId: this.props.lineId, machineId: item.item.machineId})}>
